  ...
  with open(output_file, 'a+') as f_object:
    ...
    for j in range (len(input_files)) :
      ...
      #update sequential iteration
        ...
        cmd1 = "g++ -pthread -O3 -o ./algorithms/helper.out ./algorithms/" + helper_program
        proc = sp.Popen(cmd1.split())
        proc.wait()
        ...
        for sleep_threads in threads_lst:
            for sleep_time in sleep_times :
                ...
                cmd2 = "./algorithms/helper.out " + "./output/logparr_" + date_time_obj +".txt "  + "./datasets/" +input_file + " " + str(total_threads) + " " + str(0) + " " + str(sleep_time) +" " + str(sleep_threads)
                if debug:
                    cmd2 += " debug"
                time_taken_par_list = []
